...
import {IOffchainLimitOrderPythLazerModule} from "../../interfaces/PythLazer/IOffchainLimitOrderPythLazerModule.sol";
...
contract OffchainLimitOrderPythLazerModule is
    IOffchainLimitOrderPythLazerModule,
    IMarketEvents,
    IAccountEvents
{
    ...
    function settleOffchainLimitOrderPythLazer(
        ...
        uint256 lastPriceCheck;
        {
            ...
            lastPriceCheck = IPythLazerERC7412Wrapper(strategy.priceVerificationContract)
                .getLatestPrice(strategy.feedId.toUint().to32(), 30)
                .toUint(); // 30 seconds
        }
