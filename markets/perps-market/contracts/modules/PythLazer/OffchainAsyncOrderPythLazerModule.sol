...
import {IOffchainOrderModule} from "../../interfaces/IOffchainOrderModule.sol";
import {IOffchainAsyncOrderPythLazerModule} from "../../interfaces/PythLazer/IOffchainAsyncOrderPythLazerModule.sol";
import {IPythLazerERC7412Wrapper} from "../../interfaces/external/IPythLazerERC7412Wrapper.sol";
import {Flags} from "../../utils/Flags.sol";
import {MathUtil} from "../../utils/MathUtil.sol";

contract OffchainAsyncOrderPythLazerModule is
    IOffchainAsyncOrderPythLazerModule,
    IMarketEvents,
    IAccountEvents
{
    ...
    function settleOffchainAsyncOrderPythLazer(
        ...
        int256 offchainPrice = IPythLazerERC7412Wrapper(strategy.priceVerificationContract)
            .getBenchmarkPrice(
                strategy.feedId.toUint().to32(),
