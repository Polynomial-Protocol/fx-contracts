 ...
 */
contract AsyncOrderSettlementPythLazerModule is
    IAsyncOrderSettlementPythLazerModule,
    IMarketEvents,
    IAccountEvents
{
    ...
    /**
     * @inheritdoc IAsyncOrderSettlementPythLazerModule
     */
    function settleOrderPythLazer(uint128 accountId) external {
        ...
        int256 offchainPrice = IPythLazerERC7412Wrapper(
            settlementStrategy.priceVerificationContract
        ).getBenchmarkPrice(
                settlementStrategy.feedId.toUint().to32(),
